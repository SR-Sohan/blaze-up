                    ...
                    <div class="row">
                        <form action="" method="post">
                            <div class="mb-3">
                                ...
                                <input type="text" name="category" class="form-control" id="exampleFormControlInput1" placeholder="Category Name">
                            </div>
                            <input class="btn btn-outline-success" type="submit" name="submit" value="Add Category">
                        </form>
